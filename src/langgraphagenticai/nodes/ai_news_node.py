...
class AINewsNode :
    def __init__(self, llm):
        """
        Initiate the AINewsNOde with API keys for Tavily and GROQ.
        """
    ...
    def fetch_news(self, state: dict) -> dict :
        ...
        # all these parameters are required for tavily client  - mentioned in documentation
    ...
    def summarize_news(self, state: dict) -> dict :
        ...
        prompt_template = ChatPromptTemplate.from_messages([
            ("system", """Summarize AI news articles into makrdown format. For each item include: 
